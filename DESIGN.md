...
The web client is a React implementation (`ARCHITECTURE.md`, where CQ-2's resolution is recorded), so it delivers native DOM semantics and these rules apply to web and mobile alike, without caveat.
